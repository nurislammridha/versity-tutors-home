...
import { ModerationHistoryUpdate, ProfileUpdate } from '../_redux/StudentManagementAction';
...
const TaskRejectionModal = (props) => {
    ...
    const handleAction = () => {
        ...
        const post = { clientInfo: itemId, title: `${userInfo?.name} reject his/her task`, redirectUrl: "/request-initiated-Student", isAdmin: true }
