...
const SendForReviewStudentList = () => {
  ...
  const submitUnderReview = (id) => {
    const obj = { search, page, limit: 20, filters: { reviewStatus: "sendForReview", isTutorAccount: false, categoryId, subCategoryId, divisionId, districtId, subDistrictId, areaId } }
  ...
  const handleUnderReview = (id) => {
    confirmAlert({
      ...
      message: `Are you sure to take this Student under review, It will be recorded?`,
      buttons: [
        {
          label: "Yes",
  ...
  useEffect(() => {
    const obj = { search, page, limit: 20, filters: { moderatorId: userInfo?._id, reviewStatus: "sendForReview", isTutorAccount: false, categoryId, subCategoryId, divisionId, districtId, subDistrictId, areaId } }
    ...
    <>
      <div className="row align-items-center mb-4 p-3 bg-white rounded shadow-sm">
        <div className="col-md-4 mb-3 mb-md-3">
          <h4 className="mb-0 fw-semibold text-primary">Send For Review Student</h4>
        </div>
...
export default SendForReviewStudentList;
