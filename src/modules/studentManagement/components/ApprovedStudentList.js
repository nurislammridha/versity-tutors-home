...
const ApprovedStudentList = () => {
  ...
  useEffect(() => {
    const obj = { search, page, limit: 20, filters: { moderatorId: userInfo?._id, reviewStatus: "approved", isTutorAccount: false, categoryId, subCategoryId, divisionId, districtId, subDistrictId, areaId } }
    ...
    <>
      <div className="row align-items-center mb-4 p-3 bg-white rounded shadow-sm">
        <div className="col-md-4 mb-3 mb-md-3">
          <h4 className="mb-0 fw-semibold text-primary">Approved Student List</h4>
        </div>
