...
import { GetProfileList, GetProfileListFilter, ModerationHistoryCreate, ProfileDelete, ProfileUpdate } from "../_redux/StudentManagementAction";
    ...
    <>
      <div className="row align-items-center mb-4 p-3 bg-white rounded shadow-sm">
        <div className="col-md-4 mb-3 mb-md-3">
          <h4 className="mb-0 fw-semibold text-primary">Request Initiated Student</h4>
        </div>
...
export default InitiatedStudentList;
