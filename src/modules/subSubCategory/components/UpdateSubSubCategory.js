...
import { AfterUpdatedFalse, SubSubCategoryUpdate, UploadSubSubCatImg } from "../_redux/SubSubCategoryAction";
...
const UpdateSubSubCategory = () => {
  ...
  const handleSubmit = () => {
    dispatch(SubSubCategoryUpdate(subSubCategory, subSubCategoryImg, categoryId, subCategoryId, id));
  };
  ...
  useEffect(() => {
    ...
    setSubCategory(location?.state?.data?.subCategoryInfo?.subCategoryName)
    setCategoryId(location?.state?.data?.categoryId)
    setSubCategoryId(location?.state?.data?.subCategoryId)
    setSubSubCategoryImg(location?.state?.data?.subSubCategoryImg)
  }, [afterUpdated, id])
  useEffect(() => {
