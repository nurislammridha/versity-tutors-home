...
//test//est//
export const SubmitSubCategory = (subCategory, category, categoryId, subCategoryImg) => (dispatch) => {
  if (subCategory.length === 0) {
    ...
    return 0;
  } else if (subCategoryImg.publicId === null) {
...
export const SubCategoryUpdate = (subCategory, subCategoryImg, category, categoryId, id) => (dispatch) => {
  if (subCategory.length === 0) {
    showToast("error", "Sub category name shouldn't be empty");
    return 0;
  } else if (category.length === 0) {
    ...
    showToast("error", "Select a sub category Photo");
    return 0;
  }
