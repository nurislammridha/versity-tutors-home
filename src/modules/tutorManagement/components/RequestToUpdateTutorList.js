...
const RequestToUpdateTutorList = () => {
  ...
  useEffect(() => {
    ...
    const obj = { search, page, limit: 20, filters: { reviewStatus: "requestToUpdate", isTutorAccount: true, categoryId, subCategoryId, divisionId, districtId, subDistrictId, areaId } }
...
export default RequestToUpdateTutorList;
